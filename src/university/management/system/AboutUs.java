...
public class AboutUs extends JFrame{
    ...
    public static void main(String[] args) {
        ...
        public AboutUs() {
            ...
            super("About Us - Indian Institute of Information Technology");
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("university/management/system/Icons/pic2.jpg"));
            ...
            JLabel l6 = new JLabel("Developed By : Trupti Pendharkar");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Roll Number - IIT2018097");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact : trupti.111198@gmail.com");
